...
const OrderCard = ({ order, isAdmin = false, onUpdateStatus }) => {
  ...
  return (
    <motion.div
      ...
      className="glass-card p-5 hover:bg-white/10 transition-all group relative overflow-hidden flex flex-col h-full"
    >
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <h4 className="text-xl font-bold text-white">#{order.id}</h4>
        </div>
        ...
        {latestLog ? (
          <div className="mt-2 p-3 bg-success/5 rounded-lg border border-success/10">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[9px] font-bold text-success uppercase">Quality Update</span>
            </div>
